      ...
      <div data-aos="fade-up">
        ...
        <div className="row gy-4">
          <div className="col-lg-6">
            ...
            <img src={ImageOne} className="img-fluid rounded-4 mb-4" alt="" />
            <p>
              Ut fugiat ut sunt quia veniam. Voluptate perferendis perspiciatis quod nisi et. Placeat debitis quia recusandae odit et consequatur voluptatem.
            ...
            <p>
              ...
              Blanditiis eligendi possimus et in cum. Quidem eos ut sint rem veniam qui. Ut ut repellendus nobis tempore doloribus debitis explicabo similique sit.
          ...
          <div className="col-lg-6">
            <div className="content ps-0 ps-lg-5">
              ...
              <ul>
                ...
                <li>
                  <CheckCircleFill /> Ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate trideta storacalaperda mastiro dolore eu fugiat nulla pariatur.
                </li>
              </ul>
              <p>
              ...
              <div className="position-relative mt-4">
                <img src={ImageTwo} className="img-fluid rounded-4" alt="" />
